...
const sections = [
  ...
  { title: '2. Description of Service', content: `Prepzo is a skill analyser and brain-mapping platform for higher education. The service includes:\n\n• Adaptive skill assessment sessions powered by Prepzo AI\n• Per-student cognitive maps across a 14-dimension rubric\n• Resume and profile intelligence\n• Personalised improvement roadmaps\n• TPO command-centre dashboards with cohort heatmaps and readiness deltas\n• Department-level analytics for institutional decision-makers\n\nFeatures may be updated, added, or removed at our discretion. We will notify users of significant changes.` },
