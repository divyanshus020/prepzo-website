    ...
    <footer className="bg-gray-950 text-white relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-24 pb-16">
        <div className="flex flex-col items-center text-center">
          ...
          <Link to="/" className="flex items-center mb-8 group" aria-label="Prepzo home">
            <img
              src={prepzoLogo}
              alt="Prepzo"
              className="h-16 md:h-20 w-auto group-hover:scale-105 transition-transform duration-500"
            />
          </Link>

          {/* Slogan */}
          <h2 className="font-display font-800 text-2xl md:text-3xl lg:text-4xl text-white mb-6 leading-tight max-w-2xl">
            An AI counsellor for <span className="text-primary-400">Indian education.</span>
          </h2>

          <p className="text-gray-400 font-body text-base md:text-lg mb-10 max-w-xl leading-relaxed">
            Powered by our own 120 billion parameter model, built for the classrooms we actually serve.
          </p>
